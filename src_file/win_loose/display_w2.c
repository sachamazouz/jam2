...
void open_coffre2(basic_struct_t *window, display_struct_t *sprite_struct)
{
    ...
    sfRenderWindow_drawSprite(window->window,sprite_struct->a.s_main.s, NULL);
    sfRenderWindow_drawSprite(window->window,sprite_struct->s_coffre.s, NULL);
...
void open_coffre(basic_struct_t *window, display_struct_t *sprite_struct)
{
        ...
        sfSprite_setPosition(sprite_struct->s_tonyface.s, sprite_struct->s_tonyface.posi);
