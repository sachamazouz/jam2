...
void init_text_end(display_struct_t *sprite_struct)
{
    ...
    sfText_setCharacterSize(sprite_struct->save_tony.text, 55);
    sfText_setString(sprite_struct->save_tony.text,
                     "Congratulations , with your help, Clinton, found his path!");
    sfText_setColor(sprite_struct->save_tony.text, sfYellow);
    sfText_setPosition(sprite_struct->save_tony.text, (sfVector2f) {70, 40});
}
...
void init_sprite_end(display_struct_t *sprite_struct)
{
    ...
    sprite_struct->t_coffre.t =
        sfTexture_createFromFile("Ressources/troupe.png", NULL);
    sprite_struct->s_coffre.rect = (sfIntRect) {0, 0, 300, 300};
    sprite_struct->s_coffre.posi = (sfVector2f) {1100, 380};
}
...
void create_win(display_struct_t *sprite_struct)
{
    ...
    sfSprite_setPosition(sprite_struct->s_coffre.s, sprite_struct->s_coffre.posi);
    sfSprite_setTextureRect(sprite_struct->s_coffre.s, sprite_struct->s_coffre.rect);
